...
| Vitaliy | House Guest | Data & Anayltics | Ideas: * Data federation (with "big data" in the data lake, * Analytics capabilities in the app using SAP BTP, SAC Embedded, * Predictive on apps data stored in HANA using hana_ml |
