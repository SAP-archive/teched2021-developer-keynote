...
| Kevin | House Guest  | iOS/ARKit | A simple ARKit application displaying the new SAP Fiori for iOS ARAnnotation Cards. "Do you know how this XY works?", "No but let me see with help of the great new ARAnnotations for the SAP Fiori for iOS SDK". |
