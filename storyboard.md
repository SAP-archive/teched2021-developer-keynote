...
| Thomas Jung | House Guest  | CAP | One of the following </br> <ul><li>everything is an event, central nervous system connecting sync and async services. Makes my life super easy as I don't have to switch mental contexts or protocols. </li><li>How easy it is to consume a service in CAP. Import the service defintion, generate the proxy, even mock the service with local CSV files </li></ul> | [Script](cap/script.md) | |
